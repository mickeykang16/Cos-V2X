...
log_level = "INFO"
work_dir = "work_dirs/infra_cam1_test"  # Different work_dir for infra_cam1
...
# ================== model ========================
with_infra_cam = True
infra_cam_select = 1  # Use infrastructure_cam1 (22% anchor visibility)
...
data_basic_config = dict(
    ...
    infra_cam_select=infra_cam_select,  # Use infrastructure_cam1
)
eval_config = dict(
    **data_basic_config,
