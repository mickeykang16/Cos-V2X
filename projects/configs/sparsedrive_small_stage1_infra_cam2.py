...
log_level = "INFO"
work_dir = "work_dirs/infra_cam2_test"  # Different work_dir for infra_cam1
...
# ================== model ========================
with_infra_cam = True
infra_cam_select = 2  # Use infrastructure_cam2 (0% anchor visibility - for testing)
...
data_basic_config = dict(
    ...
    infra_cam_select=infra_cam_select,  # Use infrastructure_cam2
)
eval_config = dict(
    **data_basic_config,
