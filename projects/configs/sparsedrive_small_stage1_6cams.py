...
log_level = "INFO"
work_dir = "work_dirs/6cams_both_infra_v6"  # 6-camera setup with both infrastructure cameras
    ...
    head=dict(
        ...
        det_head=dict(
            ...
            sampler=dict(
                ...
                cls_weight=2.0,
                box_weight=0.25,
                # Give some weight to velocity (last 2 dims) for better matching
            ...
            # Increase velocity weight (last 2 dims) from 1.0 to 2.0
