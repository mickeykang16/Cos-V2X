...
length = {'trainval': 12863, 'mini': 323} # train: 12263, val: 1336, test: 3276
...
work_dir = "work_dirs/6cams_both_infra_v8_v2x_stage1_top100_fix"
...
model = dict(
    ...
    head=dict(
        ...
        # Shared InstanceBank injected into both det heads at init time.
