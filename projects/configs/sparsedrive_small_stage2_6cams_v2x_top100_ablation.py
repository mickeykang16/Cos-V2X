...
length = {'trainval': 12863, 'mini': 323}
...
log_level = "INFO"
# top100: bandwidth-limited fusion — only top-100 infra anchors are transmitted
work_dir = "work_dirs/6cams_both_infra_v8_v2x_stage2_top100_fix"
...
model = dict(
    ...
    head=dict(
        ...
        motion_plan_head=dict(
            ...
            # Model predicts ego_status; optimise with L1 loss.
            ...
            # Use model-predicted ego status (as in original SparseDrive).
            # GT ego status is NOT injected; the model predicts it and
            # plan_loss_status optimises the prediction.
...
eval_config = dict(
    **data_basic_config,
    ann_file=anno_root + 'nuscenes_infos_test_novel.pkl',
