...
log_level = "INFO"
work_dir = "work_dirs/4cams_only_vehicle_v6_stage2"
...
infra_cam_select = 1  # 0: both, 1: infrastructure_cam1 only (22% visibility), 2: cam2 only (0% visibility)
num_cams = 5 if with_infra_cam else 4  # 4 vehicle + 1 infra
...
data_basic_config = dict(
    ...
    infra_cam_select=infra_cam_select,  # Use infrastructure_cam1 only
)
eval_config = dict(
    **data_basic_config,
...
# ================== pretrained model ========================
load_from = 'work_dirs/4cams_only_vehicle_v6/latest.pth'
# resume_from = 'work_dirs/4cams_only_vehicle_v6_stage2/latest.pth'