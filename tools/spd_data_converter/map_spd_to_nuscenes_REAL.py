...
# self-contained: these helpers also live in spd_to_uniad_REAL (avoids shipping the large base spd_to_uniad.py)
from spd_to_uniad_REAL import load_json, write_json, gen_token
